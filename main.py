...
# german
schedule.every().day.at('08:10').do(hist_CHANNEL_DE_events)
...
# spanish
schedule.every().day.at('08:10').do(hist_CHANNEL_ES_events)
...
# french
schedule.every().day.at('08:10').do(hist_CHANNEL_FR_events)
...
# turkish
schedule.every().day.at('08:10').do(hist_CHANNEL_TR_events)
schedule.every().friday.at('00:00').do(message_CHANNEL_TR_alert)

# ukrainain
schedule.every().day.at('08:10').do(hist_CHANNEL_UK_events)
...
# vietnamese
schedule.every().day.at('08:10').do(hist_CHANNEL_VI_events)
schedule.every().friday.at('00:00').do(message_CHANNEL_VI_alert)


# chinese
schedule.every().day.at('08:10').do(hist_CHANNEL_ZH_events)
